...
export function deleteAction(url,parameter) {
  return axios({ url: url, method: 'delete', params: parameter });
}
...
export function downloadFile(url, fileName, parameter) {
  return downFile(url, parameter).then((data) => {
    ...
    var name = fileName || decodeURI(filename.slice(filename.indexOf('filename=') + 9))
...
// export function PathParams (url, paramsObj) {
